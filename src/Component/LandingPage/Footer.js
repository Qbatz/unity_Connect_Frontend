    ...
    <footer className="bg-#FAF9FF py-10 px-5 lg:px-20 mt-20">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 gap-10">
        ...
        <div className="sm:col-span-12 md:col-span-12 lg:col-span-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="font-semibold text-gray-900 text-xl mb-3 font-Gilroy">Company</h3>
            <ul className="text-gray-600 text-base space-y-6 font-Gilroy">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 text-xl mb-3 font-Gilroy">Resources</h3>
            <ul className="text-gray-600 text-base space-y-6 font-Gilroy">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 text-xl mb-3 font-Gilroy">Help</h3>
            <ul className="text-gray-600 text-base space-y-6 font-Gilroy">
