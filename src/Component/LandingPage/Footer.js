    ...
    <footer className="bg-[#FAF9FF] w-full py-10 px-5 lg:px-20 mt-20">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 gap-10">
        <div className="sm:col-span-12 md:col-span-12 lg:col-span-6">
          ...
          <p className="text-black text-base font-Gilroy font-normal leading-[25.6px] mt-5">
        ...
        <div className="sm:col-span-12 md:col-span-12 lg:col-span-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="font-semibold text-black text-xl mb-4 font-Gilroy">Company</h3>
            <ul className="text-black font-normal text-base space-y-6 font-Gilroy">
          ...
          <div>
            <h3 className="font-semibold text-black text-xl mb-4 font-Gilroy">Resources</h3>
            <ul className="text-black font-normal text-base space-y-6 font-Gilroy">
          ...
          <div>
            <h3 className="font-semibold text-black text-xl mb-4 font-Gilroy">Help</h3>
            <ul className="text-black font-normal text-base space-y-6 font-Gilroy">
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start md:items-center mt-20">
        <p className="font-Outfit font-light text-base text-black">
