...
function GetStarted() {
  ...
  return (
    ...
    <div
      className="relative border rounded-[60px] text-center shadow-lg overflow-auto px-4 sm:px-6 md:px-10 py-10 sm:py-16 lg:py-24"
      style={{
    ...
    >
      ...
      <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-Gilroy font-semibold text-white mt-4 leading-snug sm:leading-snug lg:leading-[67.2px]">
