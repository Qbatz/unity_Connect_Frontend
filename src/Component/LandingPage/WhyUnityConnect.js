    ...
    <>
      <div>
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-4 lg:gap-200 mt-20">
          ...
          <p className="why-text font-Gilroy font-bold text-6xl tracking-normal text-center lg:text-left mt-10 md:mt-10 sm:mt-10">
            Why Unity Connect?
          </p>

        </div>

        <div className="container mx-auto mt-10 md:mt-10 sm:mt-10">
          <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 px-5 gap-6">


            <div className="bg-#FAF9FF p-6 rounded-[30px] flex flex-col items-center text-center border-l-[1px]
           border-violet-700 border-t-[1px] border-r-[1px] border-b-[1px] border-teal-500 border-t-teal-500 
           border-r-teal-500 border-b-teal-500" >
