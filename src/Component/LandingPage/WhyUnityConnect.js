    ...
    <>
      <div className="w-full px-4 py-10">
        ...
        <div className="flex flex-col items-center lg:flex-row lg:justify-start gap-4">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center lg:text-left font-Gilroy">
            Why Unity Connect?
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
          ...
          <div className="bg-[#FAF9FF] p-6 rounded-[30px] flex flex-col items-center text-center border border-teal-500">
