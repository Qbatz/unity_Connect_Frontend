    ...
    <footer className="bg-[#FAF9FF] py-10 px-5 lg:px-20 mt-20">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 gap-10">
        ...
        <div className="sm:col-span-12 md:col-span-12 lg:col-span-6">
          ...
          <p className="text-gray-700 text-[16px] font-normal leading-[25.6px] mt-5">
            Invest as a community, withdraw with
            <span className="block">trust, and repay with growth.</span>
          </p>
        </div>

        <div className="sm:col-span-12 md:col-span-12 lg:col-span-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="font-semibold text-gray-900 text-[20px] mb-3">Company</h3>
            <ul className="text-gray-600 text-[16px] space-y-6">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 text-[20px] mb-3">Resources</h3>
            <ul className="text-gray-600 text-[16px] space-y-6">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 text-[20px] mb-3">Help</h3>
            <ul className="text-gray-600 text-[16px] space-y-6">
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start md:items-center mt-20">
        <p className="text-gray-600 text-xs text-[16px]">
          © 2024 Unity Connect. All rights reserved.
        </p>
        <div className="flex space-x-6 mt-4 md:mt-0 lg:mr-[80px] justify-end">
