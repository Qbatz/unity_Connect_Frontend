...
const Settings = () => {
  ...
  return (
    ...
    <h2 
  className="text-2xl font-semibold leading-[28.63px] text-black mb-4" 
  style={{ fontFamily: 'Gilroy', letterSpacing: '0%' }}
>
  Settings
</h2>

      <div className="border-b border-gray-300 flex space-x-100 mt-10">
  <button
    onClick={() => setActiveTab("Member ID")}
    className={`pb-2 text-grayCustom text-base font-medium transition-all relative`}
  >
    Member ID
    <span
      className={`absolute left-1/2 bottom-0 h-2 w-100 -translate-x-1/2 transition-all ${
