...
function AddMemberForm() {
    ...
    return (
        ...
        //     <div className="relative bg-white rounded-3xl shadow-lg p-5 w-full max-w-sm md:max-w-md lg:max-w-lg ">
        ...
        <div className="flex justify-center items-center overflow-hidden bg-pink-500">
